...
export default async function PnlPage({ searchParams }: { searchParams: { start?: string; end?: string } }) {
  ...
  const { revenue, expenses, totalRevenue, totalExpenses, netIncome } = await getPnl(start, end);
  ...
  return (
    <main>
      ...
      <div className="panel" style={{ padding: 20, background: "rgba(59, 82, 55, 0.62)", borderColor: "var(--canopy-lt)" }}>
